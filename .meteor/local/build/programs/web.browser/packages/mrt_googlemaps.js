...
///////////////////////////////////////////////////////////////////////
//                                                                   //
// packages/mrt_googlemaps/packages/mrt_googlemaps.js                //
//                                                                   //
///////////////////////////////////////////////////////////////////////
                                                                     //
(function () {                                                       // 1
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/mrt:googlemaps/googlemaps.js                                                                               //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var root = this;                                                                                                       // 1
...
GoogleMaps.callback = function() {                                                                                     // 8
    for (key in GoogleMaps.callbacks) {                                                                                // 9
        GoogleMaps.callbacks[key](null);                                                                               // 10
    }                                                                                                                  // 11
...
GoogleMaps.init = function(parameters, callback) {                                                                     // 15
    ...
    script.async = !0;                                                                                                 // 34
    script.src = ("https:" === document.location.protocol ? "https:" : "http:") + '//maps.googleapis.com/maps/api/js'; // 35
                                                                                                                       // 36
