...
install("erasaur:meteor-lodash");                                            // 79
install("stolinski:stylus-multi");                                           // 80
install("fortawesome:fontawesome");                                          // 81
install("callback-hook");                                                    // 82
install("spiderable");                                                       // 83
install("fastclick");                                                        // 84
install("ui");                                                               // 85
install("session");                                                          // 86
install("raix:handlebar-helpers");                                           // 87
install("aldeed:simple-schema");                                             // 88
install("raix:eventemitter");                                                // 89
install("aldeed:collection2-core");                                          // 90
install("aldeed:schema-index");                                              // 91
install("aldeed:schema-deny");                                               // 92
install("aldeed:collection2");                                               // 93
install("livedata");                                                         // 94
install("momentjs:moment");                                                  // 95
install("aldeed:autoform");                                                  // 96
install("npm-bcrypt");                                                       // 97
install("ddp-rate-limiter");                                                 // 98
install("localstorage");                                                     // 99
install("accounts-base", "meteor/accounts-base/client_main.js");             // 100
install("sha");                                                              // 101
install("srp");                                                              // 102
install("accounts-password");                                                // 103
install("coffeescript");                                                     // 104
install("zimme:active-route");                                               // 105
install("gwendall:auth-client-callbacks");                                   // 106
install("meteortoys:toykit");                                                // 107
install("msavin:mongol");                                                    // 108
install("msavin:jetsetter");                                                 // 109
install("meteortoys:blueprint");                                             // 110
install("meteortoys:authenticate");                                          // 111
install("meteortoys:shell");                                                 // 112
install("meteortoys:method");                                                // 113
install("meteortoys:result");                                                // 114
install("meteortoys:autopub");                                               // 115
install("meteortoys:pub");                                                   // 116
install("meteortoys:sub");                                                   // 117
install("meteortoys:email");                                                 // 118
install("meteortoys:listen");                                                // 119
install("meteortoys:throttle");                                              // 120
install("meteortoys:status");                                                // 121
install("meteortoys:hotreload");                                             // 122
install("meteortoys:allthings");                                             // 123
install("less");                                                             // 124
install("notorii:array");                                                    // 125
install("lukemadera:autoform-autocomplete");                                 // 126
install("url");                                                              // 127
install("http");                                                             // 128
install("meteorhacks:search-source");                                        // 129
install("mrt:copy-template");                                                // 130
install("dandv:caret-position");                                             // 131
install("mizzao:autocomplete");                                              // 132
install("mpowaga:autoform-autocomplete");                                    // 133
install("comerc:bs-typeahead");                                              // 134
install("comerc:autoform-typeahead");                                        // 135
install("sergeyt:typeahead");                                                // 136
install("jeremy:selectize");                                                 // 137
install("comerc:autoform-selectize");                                        // 138
install("easysearch:core");                                                  // 139
install("peerlibrary:assert");                                               // 140
install("peerlibrary:reactive-field");                                       // 141
install("peerlibrary:computed-field");                                       // 142
install("peerlibrary:base-component");                                       // 143
install("peerlibrary:data-lookup");                                          // 144
install("peerlibrary:blaze-components");                                     // 145
install("easysearch:components");                                            // 146
install("easy:search");                                                      // 147
install("easysearch:autosuggest");                                           // 148
install("mrt:googlemaps");                                                   // 149
install("amplify");                                                          // 150
install("u2622:persistent-session");                                         // 151
install("aldeed:geocoder");                                                  // 152
install("muriloventuroso:get-coordinates");                                  // 153
install("mdg:geolocation");                                                  // 154
install("matb33:collection-hooks");                                          // 155
install("gfk:notifications");                                                // 156
install("useraccounts:core");                                                // 157
install("softwarerero:accounts-t9n");                                        // 158
install("useraccounts:flow-routing");                                        // 159
install("useraccounts:materialize");                                         // 160
install("materialize:materialize");                                          // 161
install("alanning:roles");                                                   // 162
install("aldeed:template-extension");                                        // 163
install("gildaspk:autoform-materialize");                                    // 164
install("planettraining:material-design-icons");                             // 165
install("edgee:slingshot");                                                  // 166
install("fourseven:scss");                                                   // 167
install("themeteorchef:bert");                                               // 168
install("peerlibrary:blocking");                                             // 169
install("peerlibrary:aws-sdk");                                              // 170
install("rzymek:fullcalendar");                                              // 171
install("webapp");                                                           // 172
install("hot-code-push");                                                    // 173
install("launch-screen");                                                    // 174
install("autoupdate");                                                       // 175
install("mdg:validation-error");                                             // 176
install("service-configuration");                                            // 177
                                                                             // 178
///////////////////////////////////////////////////////////////////////////////
